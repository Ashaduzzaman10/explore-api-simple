...
const carDetails = data.forEach(car => {
  const perCar = document.createElement("div");
  perCar.classList.add("col");
  perCar.innerHTML = `
  <div class="col">
          <div class="card">
            ...
            <div class="card-body">
              ...
              <button class="btn btn-primary" type="button">Car Price : ${car.price} </button>
            </div>
          </div>
        </div>
  `;
  carContainer.appendChild(perCar)
